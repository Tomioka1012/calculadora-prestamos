    ...
    <>
      <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
        ...
        <div className="flex justify-between my-6">
          <Button 
            operador='-'
            evento={handleClickDecremento}
          />
          <Button 
            operador='+'
            evento={handleClickIncremento}
          />
        ...
        <select name="" id="" className='mt-5 w-full p-2 bg-white border border-gray-300 rounded-lg text-center 
